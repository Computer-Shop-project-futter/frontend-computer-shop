                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text(
                            'Clear the active filters or refresh the page to load all available items.',
                            textAlign: TextAlign.center,
                            ...
                            delegate: SliverChildBuilderDelegate(
                              (context, index) {
                                ...
                                return ProductCard(
                                  product: product,
                                  imageFallbackAsset:
                                      _catalogAssets[index % _catalogAssets.length],
                                  onTap: () => context.go('/products/${product.productId}'),
                                  isSelectedForCompare: compareIds.contains(product.productId),
                                  onCompareToggle: (_) => ref.read(compareProvider.notifier).toggle(product.productId),
                                  onAddToCart: () {
