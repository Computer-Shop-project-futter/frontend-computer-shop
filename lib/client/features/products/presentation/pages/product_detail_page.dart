...
import 'package:computer_shop/client/features/compare/presentation/providers/compare_provider.dart';
...
class ProductDetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Debug: Print product ID and state
    ref.listen(productDetailProvider(productId), (previous, next) {
      next.whenData((data) {
        print('✅ Product loaded: ${data.product.name} (ID: $productId)');
      });
    });
