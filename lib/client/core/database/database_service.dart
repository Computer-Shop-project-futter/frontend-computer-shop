...
class DatabaseService {
  ...
  Future<void> _onCreate(Database db, int version) async {
    ...
    // Users table for local auth cache
    try {
      await db.execute('''
        CREATE TABLE users (
      ...
      // Some platforms or older DB versions may already have users table
      print('Users table create warning: $e');
    }
  }
  ...
  Future<void> _onUpgrade(Database db, int oldVersion, int newVersion) async {
    if (oldVersion < 2) {
      ...
      try {
        ...
        print('Users upgrade/create warning: $e');
      }
    }
  }
