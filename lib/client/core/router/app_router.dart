...
import 'package:computer_shop/client/features/coupons/presentation/pages/coupon_page.dart';
...
class AppRouter {
  ...
  static void goCoupon(BuildContext context, {String? productId}) =>
      context.go('/coupon${productId != null ? '?productId=$productId' : ''}');
}
