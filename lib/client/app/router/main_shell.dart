            ...
            children: [
              ...
              TextField(
                ...
                onSubmitted: (value) {
                  ...
                  context.go('/products${query.isNotEmpty ? '?search=${Uri.encodeComponent(query)}' : ''}');
                },
                decoration: InputDecoration(
                  hintText: 'Search for laptops, builds, accessories...',
                  filled: true,
              ...
              const SizedBox(height: 16),
              const Text(
                'Tap search to filter product listings by name or description.',
